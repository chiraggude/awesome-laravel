...
* [Laravel Code Generator](https://github.com/CrestApps/laravel-code-generator) - A clean code generator with smart migrations, table relations, multiple language support. 
