...
* [Setting](https://github.com/Phil-F/Setting) ([L5 here](https://github.com/thetispro/laravel5-setting)) - Persistent configuration settings that are stored in JSON files
