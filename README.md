...
* [Laravel-Uuid](https://github.com/EmadAdly/laravel-uuid) - by using this package you will get when each new entry on (generate Uuid automatically and assign it to uuid field in database automatically, and easy find it based uuid method)
