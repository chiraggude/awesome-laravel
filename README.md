...
![alt text](https://img.shields.io/github/stars/amranidev/scaffold-interface "Logo Title Text 1") [Scaffold Interface](https://github.com/amranidev/scaffold-interface) - A Smart CRUD Generator For Laravel 
