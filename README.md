...
* [Laravel Validation Rules](https://laravel-validation-rules.github.io) - A community driven set of custom validation rules, that are not part of the core framework
